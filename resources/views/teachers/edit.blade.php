...
<div class="max-w-xl">
    ...
    <div class="card">
        <div class="px-6 py-5 border-b border-gray-50">
            <h1 class="text-base font-semibold text-gray-900">Edit Teacher</h1>
            <p class="text-sm text-gray-400 mt-0.5">Update details for <span class="font-medium text-gray-600">{{ $teacher->name }}</span>.</p>
        </div>
